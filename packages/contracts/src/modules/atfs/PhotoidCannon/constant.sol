...
uint24 constant COMMON_ACTIVATE_AFTER_MOVE = 0x06_03_0A;
uint24 constant RARE_ACTIVATE_AFTER_MOVE = 0x06_03_0B;
uint24 constant EPIC_ACTIVATE_AFTER_MOVE = 0x06_03_0C;
uint24 constant LEGENDARY_ACTIVATE_AFTER_MOVE = 0x06_03_0D;
uint24 constant MYTHIC_ACTIVATE_AFTER_MOVE = 0x06_03_0E;
