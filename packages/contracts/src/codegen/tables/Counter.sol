...
library Counter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "df", name: "Counter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626466000000000000000000000000436f756e746572000000000000000000);
