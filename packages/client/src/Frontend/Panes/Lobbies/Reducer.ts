...
export function ofMaxArtifactPerPlanet(
  {
    type,
    value,
  }: Extract<LobbyConfigAction, { type: "MAX_ARTIFACT_PER_PLANET" }>,
  state: LobbyConfigState,
) {
  if (value === undefined) {
    return {
...
export function ofBurnPlanetEffectRadius(
  {
    type,
    value,
  }: Extract<LobbyConfigAction, { type: "BURN_PLANET_LEVEL_EFFECT_RADIUS" }>,
  state: LobbyConfigState,
) {
  if (value === undefined) {
    return {
...
export function ofBurnPlanetRequireSilverAmounts(
  {
    type,
    value,
  }: Extract<LobbyConfigAction, { type: "BURN_PLANET_REQUIRE_SILVER_AMOUNTS" }>,
  state: LobbyConfigState,
) {
  if (value === undefined) {
    return {
...
export function ofKardashevEffectRadius(
  {
    type,
    value,
  }: Extract<LobbyConfigAction, { type: "KARDASHEV_EFFECT_RADIUS" }>,
  state: LobbyConfigState,
) {
  if (value === undefined) {
    return {
...
export function ofKardashevRequireSilverAmounts(
  {
    type,
    value,
  }: Extract<LobbyConfigAction, { type: "KARDASHEV_REQUIRE_SILVER_AMOUNTS" }>,
  state: LobbyConfigState,
) {
  if (value === undefined) {
    return {
...
export function ofTransferEnergyRequireSilverAmounts(
  {
    type,
    value,
  }: Extract<LobbyConfigAction, { type: "BLUE_PANET_REQUIRE_SILVER_AMOUNTS" }>,
  state: LobbyConfigState,
) {
  if (value === undefined) {
    return {
