...
function TutorialPaneContent({
  ...
  if (tutorialState === TutorialState.None) {
    ...
    return (
      <div>
        Welcome to the universe. You&apos;ve initialized with 50 energy on your
        home planet, in a NEBULA.
        <br />
        <br />
    ...
    return (
      <div>
        Congrats, you&apos;ve submitted a move to ${BLOCKCHAIN_NAME}! Moves that
    ...
    return (
      <div className="tutzoom">
        Great! You&apos;ll notice that most of the universe appears grayed out.
        You need to explore those areas before you can view them.
        <br />
        <br />
        You&apos;ll notice a target <Icon type={IconType.Target} /> indicating
        where you are currently exploring.{" "}
    ...
    return (
      <div className="tutzoom">
        ...
        <div>
          ...
          how far away it is from the center of the universe.
        </div>
        <div>
