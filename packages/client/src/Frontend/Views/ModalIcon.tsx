...
const icon = (modal: ModalName): React.ReactNode => {
  if (modal === ModalName.Help) {
    return <Icon type={IconType.Help} />;
  ...
  } else if (modal === ModalName.MapShare) {
    return <Icon type={IconType.Share} />;
  } else if (modal === ModalName.ManageAccount) {
    return <Icon type={IconType.Lock} />;
  } else if (modal === ModalName.Hats) {
    return <Icon type={IconType.Hat} />;
  } else if (modal === ModalName.Settings) {
    return <Icon type={IconType.Settings} />;
  } else if (modal === ModalName.Plugins) {
    return <Icon type={IconType.Plugin} />;
