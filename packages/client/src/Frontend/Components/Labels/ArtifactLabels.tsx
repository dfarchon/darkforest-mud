...
import { isAvatar, isLogo, isMeme, numToAvatarType, numToLogoType, numToMemeType } from "@df/procedural";
import {
  Artifact,
  ArtifactRarity,
  ArtifactRarityNames,
...
export const ArtifactRarityText = ({ rarity }: { rarity: ArtifactRarity }) => <>{ArtifactRarityNames[rarity]}</>;
