...
export const FoundSpacetimeRip = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src="/public/icons/alerts/planettypes/tradingpost.svg" />;
};
...
export const TxInitialized = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src="/public/icons/alerts/transactions/initialized.svg" />;
};
