...
export function isUnconfirmedRefreshPlanet(txIntent: TxIntent): txIntent is UnconfirmedRefreshPlanet {
...
export function isUnconfirmedAddMemberByAdmin(txIntent: TxIntent): txIntent is UnconfirmedAddMemberByAdmin {
...
export function isUnconfirmedSendApplication(txIntent: TxIntent): txIntent is UnconfirmedSendApplication {
  return txIntent.methodName === "sendApplication";
}

export function isUnconfirmedCancelApplication(txIntent: TxIntent): txIntent is UnconfirmedCancelApplication {
  return txIntent.methodName === "cancelApplication";
}

export function isUnconfirmedRejectApplication(txIntent: TxIntent): txIntent is UnconfirmedCancelApplication {
  return txIntent.methodName === "rejectApplication";
}

export function isUnconfirmedAcceptApplication(txIntent: TxIntent): txIntent is UnconfirmedAcceptApplication {
...
export function isUnconfirmedTransferLeaderRole(txIntent: TxIntent): txIntent is UnconfirmedTransferLeaderRole {
  return txIntent.methodName === "transferLeaderRole";
}

export function isUnconfirmedChangeUnionName(txIntent: TxIntent): txIntent is UnconfirmedChangeUnionName {
...
export function isUnconfirmedRefreshPlanetTx(tx: Transaction): tx is Transaction<UnconfirmedRefreshPlanet> {
...
export function isUnconfirmedBuyArtifactTx(tx: Transaction): tx is Transaction<UnconfirmedBuyArtifact> {
...
export function isUnconfirmedBuySpaceshipTx(tx: Transaction): tx is Transaction<UnconfirmedBuySpaceship> {
...
export function isUnconfirmedAddMemberByAdminTx(tx: Transaction): tx is Transaction<UnconfirmedAddMemberByAdmin> {
...
export function isUnconfirmedInviteMemberTx(tx: Transaction): tx is Transaction<UnconfirmedInviteMember> {
  return isUnconfirmedInviteMember(tx.intent);
}

export function isUnconfirmedCancelInviteTx(tx: Transaction): tx is Transaction<UnconfirmedCancelInvite> {
  return isUnconfirmedCancelInvite(tx.intent);
}

export function isUnconfirmedAcceptInviteTx(tx: Transaction): tx is Transaction<UnconfirmedAcceptInvite> {
  return isUnconfirmedAcceptInvite(tx.intent);
}

export function isUnconfirmedSendApplicationTx(tx: Transaction): tx is Transaction<UnconfirmedSendApplication> {
  return isUnconfirmedSendApplication(tx.intent);
}

export function isUnconfirmedCancelApplicationTx(tx: Transaction): tx is Transaction<UnconfirmedCancelApplication> {
  return isUnconfirmedCancelApplication(tx.intent);
}

export function isUnconfirmedRejectApplicationTx(tx: Transaction): tx is Transaction<UnconfirmedRejectApplication> {
  return isUnconfirmedRejectApplication(tx.intent);
}

export function isUnconfirmedAcceptApplicationTx(tx: Transaction): tx is Transaction<UnconfirmedAcceptApplication> {
  return isUnconfirmedAcceptApplication(tx.intent);
}

export function isUnconfirmedLeaveUnionTx(tx: Transaction): tx is Transaction<UnconfirmedLeaveUnion> {
  return isUnconfirmedLeaveUnion(tx.intent);
}

export function isUnconfirmedKickMemberTx(tx: Transaction): tx is Transaction<UnconfirmedKickMember> {
  return isUnconfirmedKickMember(tx.intent);
}

export function isUnconfirmedTransferLeaderRoleTx(tx: Transaction): tx is Transaction<UnconfirmedTransferLeaderRole> {
  return isUnconfirmedTransferLeaderRole(tx.intent);
}

export function isUnconfirmedChangeUnionNameTx(tx: Transaction): tx is Transaction<UnconfirmedChangeUnionName> {
  return isUnconfirmedChangeUnionName(tx.intent);
}

export function isUnconfirmedDisbandUnionTx(tx: Transaction): tx is Transaction<UnconfirmedDisbandUnion> {
  return isUnconfirmedDisbandUnion(tx.intent);
}

export function isUnconfirmedLevelUpUnionTx(tx: Transaction): tx is Transaction<UnconfirmedLevelUpUnion> {
